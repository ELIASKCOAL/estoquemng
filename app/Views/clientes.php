...
<body>
    <header>
        ...
        <nav>
            ...
            <a href="<?= base_url('addclientes') ?>" class="nav-link">
        ...
        <div class="table-container">
                    ...
                    <tbody>
                        <?php foreach ($clientes as $cliente) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('editcliente/' . $cliente['id']) ?>" class="btn btn-primary">
                                        <i class="fas fa-edit"></i> Editar
                                    </a>
                                    <a href="<?= base_url('deletecliente/' . $cliente['id']) ?>" 
                                       class="btn btn-danger"
                                       onclick="return confirm('Tem certeza que deseja excluir o cliente \'<?= esc($cliente['nome']) ?>\'?')">
            ...
            <?php else : ?>
                <div class="empty-state">
                    ...
                    <p>Você ainda não possui nenhum cliente cadastrado no sistema.</p>
                    <a href="<?= base_url('addclientes') ?>" class="btn-add-empty">
